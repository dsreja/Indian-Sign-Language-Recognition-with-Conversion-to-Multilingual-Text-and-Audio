...
IMAGES_PATH = r'C:/Users/KIIT/OneDrive/Desktop/MinorProj/datasets'
...
# Optionally, you can continue with the rest of your code here
# For example, training a model using the padded data